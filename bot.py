...
def handle_message(message):
    ...
    if text in knowledge:
        ...
        msg = bot.reply_to(message, "Извини, я пока не знаю ответ на этот вопрос. Для моего скорейшего обучения напиши моему хозяину @Remzzaa.", reply_markup=get_end_keyboard())
        last_bot_message[user_id] = msg.message_id
